...
# Dump of table ibei_mall_cart
# ------------------------------------------------------------

DROP TABLE IF EXISTS `ibei_mall_cart`;

CREATE TABLE `ibei_mall_cart` (
...
# Dump of table ibei_mall_category
# ------------------------------------------------------------

DROP TABLE IF EXISTS `ibei_mall_category`;

CREATE TABLE `ibei_mall_category` (
...
LOCK TABLES `ibei_mall_category` WRITE;
/*!40000 ALTER TABLE `ibei_mall_category` DISABLE KEYS */;

INSERT INTO `ibei_mall_category` (`id`, `name`, `type`, `parent_id`, `order_num`, `create_time`, `update_time`)
VALUES
...
/*!40000 ALTER TABLE `ibei_mall_category` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table ibei_mall_order
# ------------------------------------------------------------

DROP TABLE IF EXISTS `ibei_mall_order`;

CREATE TABLE `ibei_mall_order` (
...
# Dump of table ibei_mall_order_item
# ------------------------------------------------------------

DROP TABLE IF EXISTS `ibei_mall_order_item`;

CREATE TABLE `ibei_mall_order_item` (
  `id` int(64) NOT NULL AUTO_INCREMENT COMMENT '主键id',
...
# Dump of table ibei_mall_product
# ------------------------------------------------------------

DROP TABLE IF EXISTS `ibei_mall_product`;

CREATE TABLE `ibei_mall_product` (
...
LOCK TABLES `ibei_mall_product` WRITE;
/*!40000 ALTER TABLE `ibei_mall_product` DISABLE KEYS */;

INSERT INTO `ibei_mall_product` (`id`, `name`, `image`, `detail`, `category_id`, `price`, `stock`, `status`, `create_time`, `update_time`)
VALUES
...
/*!40000 ALTER TABLE `ibei_mall_product` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table ibei_mall_user
# ------------------------------------------------------------

DROP TABLE IF EXISTS `ibei_mall_user`;

CREATE TABLE `ibei_mall_user` (
...
LOCK TABLES `ibei_mall_user` WRITE;
/*!40000 ALTER TABLE `ibei_mall_user` DISABLE KEYS */;

INSERT INTO `ibei_mall_user` (`id`, `username`, `password`, `personalized_signature`, `role`, `create_time`, `update_time`)
VALUES
...
/*!40000 ALTER TABLE `ibei_mall_user` ENABLE KEYS */;
UNLOCK TABLES;
