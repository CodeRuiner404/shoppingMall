...
import com.ibei.mall.model.request.UpdateProductRequest;
...
@RestController//这个注解相当于自动替类中所有方法加上了@ResponsBody
public class ProductAdminController {
    ...
    public ApiRestResponse upload(HttpServletRequest httpServletRequest,@RequestParam("file") MultipartFile file){
        ...
        try {
            ...
            return ApiRestResponse.fail(MallExceptionEnum.UPLOAD_FAILED);
        }
    }
